...
#ifndef CFT_TESTTASK_SWIFT_H
#define CFT_TESTTASK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CFT_TestTask",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CFT_TestTask11AppDelegate")
...
SWIFT_CLASS("_TtC12CFT_TestTask18InfoViewController")
...
SWIFT_CLASS("_TtC12CFT_TestTask24NoteDetailViewController")
...
@interface NoteDetailViewController (SWIFT_EXTENSION(CFT_TestTask))
- (void)dismissKeyboard;
- (void)kbWillShow:(NSNotification * _Nonnull)notification;
- (void)kbWillHide;
@end


SWIFT_CLASS("_TtC12CFT_TestTask17NoteTableViewCell")
...
SWIFT_CLASS("_TtC12CFT_TestTask18NoteViewController")
...
@interface NoteViewController (SWIFT_EXTENSION(CFT_TestTask))
- (void)addAction;
- (void)editAction;
@end
...
@interface NoteViewController (SWIFT_EXTENSION(CFT_TestTask)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC12CFT_TestTask13SceneDelegate")
